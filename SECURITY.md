...
If you find a security vulnerability in toolbox, please report it through [GitHub's private vulnerability reporting](https://github.com/binnietom/toolbox/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact thomas.ajbinnie@gmail.com for details.
